                        ...
                        <div className="inspectionModalFormFront">
                            <div className="inspectionModalH">
                                <h1>Edit seller details </h1>
                                    <button className={'closeModalButton'} onClick={this.props.closeModal}><strong>X</strong></button>
                            </div>
                            <form onSubmit={this.handleSubmit} className={'sellerForm'}>
                                <div className='sellerformSection'>
                                    ...
                                    {errors.photoLicense && (
                                        ...
                                        <Fragment>
                                            ...
                                            <img alt={this.state.photoLicense} src={'../../../static/' + this.state.photoLicense}/>
                                            </div>
                                        </Fragment>
                                    }
                                    ...
                                    {!this.state.editSeller  && (<button type="submit" className="btnSellerFormSubmit" onClick={this.handleDisableForm}>
                                        Edit
                                    </button>)}
                                </div>
                                ...
                                <div className={'sellerformSection'}>
                                    ...
                                    <div className={'sellerScheduleFormSection'}>
                                        ...
                                        <button className={'btnSellerCheckMap'} onClick={this.handleAddSchedule} disabled={!this.state.editSeller}>
                                            Add schedule
                                        </button>
                                        {errors.schedule && (
...
export default connect(mapStateToProps, {registerSeller, uploadImage, getCountry, getFood})(withRouter(SellerModal))